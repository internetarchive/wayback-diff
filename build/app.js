...
var webMonitoringProcessingURL = 'http://83.212.100.61';
var webMonitoringProcessingPort = '8888';
path = path.split('/');

var site = path[path.length - 1];
if (path.length === 3) {
  reactDom.render(react.createElement(DiffContainer, { site: site, fetchCallback: null,
  ...
  reactDom.render(react.createElement(DiffContainer, { site: site, timestampA: timestampA, timestampB: timestampB,
    webMonitoringProcessingURL: webMonitoringProcessingURL, waybackLoaderPath: 'https://users.it.teithe.gr/~it133996/wayback-loader.svg',
