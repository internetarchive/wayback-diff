...
describe('scaleCluster', () => {
  it('computes clusters correctly for well-separated groups', () => {
  ...
  it('returns single breakpoint-free cluster when all values identical', () => {
  ...
  it('reduces cluster count when fewer unique values than range buckets', () => {
  ...
  it('handles floating-point similarity percentages', () => {
  ...
  it('preserves monotonicity: higher input never maps to lower range', () => {
  ...
  it('domain and range getters return current values', () => {
    const d = [1, 2, 3];
    const r = [10, 20, 30];
